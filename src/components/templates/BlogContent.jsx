...
import figureTitle from "../../assets/pages/blogs/figure_title.svg";
import icon from "../../assets/pages/blogs/icon.svg";
import btnIcon from "../../assets/pages/blogs/btn_icon.svg";
